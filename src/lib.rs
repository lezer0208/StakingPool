...
#[derive(Debug)]
pub struct StakingPoolProcessor {
    verbose: bool,
    processed_count: usize,
}

impl StakingPoolProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting StakingPool processing");
    
    let mut processor = StakingPoolProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = StakingPoolProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = StakingPoolProcessor::new(false);
